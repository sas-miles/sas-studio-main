...
This is an unofficial fork of the [Payload Website Template](https://github.com/payloadcms/payload/blob/main/templates/website). Use it to power websites, blogs, or portfolios from small to enterprise. This repo includes a fully-working backend, enterprise-grade admin panel, and a beautifully designed, production-ready website.

*The biggest difference is that this template uses the [Feature Sliced Design](https://feature-sliced.design/) approach to folder structure.*
